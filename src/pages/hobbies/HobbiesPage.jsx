...
const p = TASK_PALETTE.hobbies;

export default function HobbiesPage() {
  return (
    <div style={{ maxWidth: 800, margin: "0 auto" }}>
      <PageHeader
        kicker="DEEP DIVE · HOBBIES"
        title="Hobbies & Projects"
        subtitle="Creative pursuits & personal projects"
      />
      <Card padding={40} style={{ textAlign: "center", position: "relative", overflow: "hidden", background: lighten(p.fg, 0.9), border: `1.5px solid ${lighten(p.fg, 0.72)}` }}>
        ...
        <div style={{ position: "relative" }}>
          ...
          <div style={{ color: THEME.inkSoft, fontSize: 14, lineHeight: 1.7, maxWidth: 380, margin: "0 auto", marginBottom: 20 }}>
            Hobby sessions, creative projects, and personal interests are tracked in an external Google Sheet. Use the Daily Tracker to mark your daily completion.
          </div>
