...
export default function HobbiesPage() {
  return (
    <div style={{ padding: "24px 20px 40px", maxWidth: 800, margin: "0 auto", fontFamily: FONTS.sans }}>
      ...
      <div style={{ padding: "40px 24px", borderRadius: 16, background: "#0D0520", border: "1px solid #7C3AED44", textAlign: "center" }}>
        <div style={{ fontSize: 48, marginBottom: 16 }}>🎨</div>
        <div style={{ fontFamily: FONTS.syne, fontSize: 18, fontWeight: 700, color: "#DDD6FE", marginBottom: 10 }}>Tracked in Google Sheets</div>
