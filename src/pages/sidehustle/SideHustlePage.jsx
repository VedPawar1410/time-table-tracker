...
const p = TASK_PALETTE.sidehustle;

export default function SideHustlePage() {
  return (
    <div style={{ maxWidth: 800, margin: "0 auto" }}>
      <PageHeader
        kicker="DEEP DIVE · SIDE HUSTLE"
        title="Side Hustle"
        subtitle="Projects, builds & entrepreneurial work"
      />
      <Card padding={40} style={{ textAlign: "center", position: "relative", overflow: "hidden", background: lighten(p.fg, 0.9), border: `1.5px solid ${lighten(p.fg, 0.72)}` }}>
        ...
        <div style={{ position: "relative" }}>
          ...
          <div style={{ color: THEME.inkSoft, fontSize: 14, lineHeight: 1.7, maxWidth: 380, margin: "0 auto", marginBottom: 20 }}>
            Side hustle sessions, ideas, and project milestones are tracked in an external Google Sheet. Use the Daily Tracker to mark your daily completion.
          </div>
