...
export default function SideHustlePage() {
  return (
    <div style={{ padding: "24px 20px 40px", maxWidth: 800, margin: "0 auto", fontFamily: FONTS.sans }}>
      ...
      <div style={{ padding: "40px 24px", borderRadius: 16, background: "#1A1000", border: "1px solid #D9770644", textAlign: "center" }}>
        <div style={{ fontSize: 48, marginBottom: 16 }}>💡</div>
        <div style={{ fontFamily: FONTS.syne, fontSize: 18, fontWeight: 700, color: "#FEF08A", marginBottom: 10 }}>Tracked in Google Sheets</div>
